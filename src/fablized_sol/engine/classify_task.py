...
_CLASSIFICATION_TABLES: Final[tuple[tuple[TaskMode, tuple[re.Pattern[str], ...]], ...]] = (
    (
        TaskMode.DEEP,
        (
            re.compile(r"\b(?:database|db|schema)\s+migrat(?:e|ion)\b", re.IGNORECASE),
            ...
            re.compile(r"(?:\ud504\ub85c\ub355\uc158|\uc6b4\uc601).*(?:\ubc30\ud3ec|\ub9c8\uc774\uadf8\ub808\uc774\uc158)"),
    ...
    (
        ...
        (
            ...
            re.compile(r"(?:\uad6c\ud604|\uc218\uc815|\ucd94\uac00|\ubcc0\uacbd|\uc791\uc131|\ub9cc\ub4e4|\ub9ac\ud329\ud130\ub9c1)"),
        ),
    ),
    (
        TaskMode.QUICK,
        (
            ...
            re.compile(r"(?:\ubb50\uc57c|\ubb50\uc9c0|\uc124\uba85|\uc694\uc57d|\ubc88\uc5ed|\uc9c8\ubb38)"),
        ),
    ),
)
